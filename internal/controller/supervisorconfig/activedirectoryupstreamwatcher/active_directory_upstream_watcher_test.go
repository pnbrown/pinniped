...
func TestActiveDirectoryUpstreamWatcherControllerSync(t *testing.T) {
	...
	providerConfigForValidUpstreamWithTLS := &upstreamldap.ProviderConfig{
		...
		RefreshAttributeChecks:       map[string]func(*ldap.Entry, string) (bool, error){"pwdLastSet": upstreamldap.PwdResetSinceLogin},
	}
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			for i := range actualIDPList {
				...
				copyOfExpectedValueForResultingCache.RefreshAttributeChecks = map[string]func(*ldap.Entry, string) (bool, error){}
				actualConfig.RefreshAttributeChecks = map[string]func(*ldap.Entry, string) (bool, error){}
